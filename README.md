...
* **Live Secure API Backend**: [https://35-224-135-36.nip.io/docs](https://35-224-135-36.nip.io/docs)
...
* **Key Course Concepts Demonstrated**:
  1. **Agent / Multi-agent system (ADK)**: Orchestrates five specialized agents (*Triage, Setup, Reproduction, Patch, and Verification*) using a directed state graph via ADK 2.0 Workflows in [agent.py](file:///c:/Users/abdul/OneDrive/Desktop/Comp Lang NEW/Antigravity - agy-cli-projects/BugRepro/bugrepro-agent/app/agent.py).
  2. **MCP Server Integration**: Features custom toolsets for secure file access and sandboxed commands in [tools.py](file:///c:/Users/abdul/OneDrive/Desktop/Comp Lang NEW/Antigravity - agy-cli-projects/BugRepro/bugrepro-agent/app/tools.py).
  ...
  4. **Hardened Security Features**: Restricts all untrusted execution to container boundary (zero host-filesystem mounts), sanitizes commands to block shell injection, and validates paths using strict regular expressions in [sandbox.py](file:///c:/Users/abdul/OneDrive/Desktop/Comp Lang NEW/Antigravity - agy-cli-projects/BugRepro/bugrepro-agent/app/sandbox.py) and [tools.py](file:///c:/Users/abdul/OneDrive/Desktop/Comp Lang NEW/Antigravity - agy-cli-projects/BugRepro/bugrepro-agent/app/tools.py).
